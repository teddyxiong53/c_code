...
#if MYLOG_TIMESTAMP
#define myprintf(...) do {\
                        fprintf(MYLOG_TARGET,"[%s][%s][%d]: ", basename(__FILE__), __func__, __LINE__);\
...
#define mylogd(...) do {\
                            ...
                            fprintf(MYLOG_TARGET,"[DEBUG][%s][%s][%d]: ", basename(__FILE__), __func__, __LINE__);\
                            fprintf(MYLOG_TARGET,__VA_ARGS__);\
                            fprintf(MYLOG_TARGET,"\n");\
                           }while(0)
#define myloge(...) do {\
		                    ...
		                    strftime(s, sizeof(s), "%Y-%m-%d %H:%M:%S", localtime(&tt));\
                            fprintf(MYLOG_TARGET,"[%s]", s);\
                            fprintf(MYLOG_TARGET,"[ERROR][%s][%s][%d]: ", basename(__FILE__), __func__, __LINE__);\
                            fprintf(MYLOG_TARGET,__VA_ARGS__);\
                            fprintf(MYLOG_TARGET,"\n");\
                           }while(0)
#define mylogw(...) do {\
		                    ...
		                    strftime(s, sizeof(s), "%Y-%m-%d %H:%M:%S", localtime(&tt));\
                            fprintf(MYLOG_TARGET,"[%s]", s);\
                            fprintf(MYLOG_TARGET,"[WARN][%s][%s][%d]: ", basename(__FILE__), __func__, __LINE__);\
                            fprintf(MYLOG_TARGET,__VA_ARGS__);\
                            fprintf(MYLOG_TARGET,"\n");\
                           }while(0)
#else
...
static inline void mydump(const void* p, size_t size) {
    ...
    fprintf(MYLOG_TARGET,"Dumping %u bytes from %p:\n", size, p);
